# Garage Prime Website & Collector Hub

Official landing page, documentation, collector FAQ, and legal hub for **Garage Prime** — the digital companion app for 1:64 die-cast and Hot Wheels collectors.

🌐 **Live URL:** [https://garage-prime.com](https://garage-prime.com) (or [https://poochie.github.io](https://poochie.github.io))
...
* **App Deep Links & Auth:**
  * `car.html`: Public shareable vehicle telemetry card.
  * `reset.html`: Password recovery terminal.
  * `welcome.html`: Email verification landing page.
  * `.well-known/assetlinks.json`: Android App Links verification for `com.garageprime.app`.